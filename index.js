...
// When nestedFunction reaches into the outer scope myFunction and access internal this process represents the closure.
// Because nestedFunction is declared within the scope of myFunction and turns possible access to its variable.
...
function USApop(zooAnimals) {
  const values = zooAnimals.reduce(function (accumulator, item) {
...
console.log("taskgreeting", greeting("Alex", "Monteiro"));
...
// class NewObject extends CuboidMaker {
...
console.log("cuboid.surface", cuboid.surfaceArea()); // 130
...
console.log("cuboid2", cuboidTwo);

//🦄🦄🦄 Test your volume and surfaceArea methods by uncommenting the logs below: 🦄🦄🦄
console.log("cuboid2.volume", cuboidTwo.volume()); // 100
console.log("cuboid2.surface", cuboidTwo.surfaceArea()); // 130
